...
class AIOTrainDataset(Dataset):
    ...
    def _init_dehaze(self, id):
        inputs = self.args.data_file_dir + "/dehazing/RESIDE/haze"
    ...
    def _get_nonhazy_name(self, hazy_name):
        # Map haze sample path to corresponding clear image in RESIDE/clear
        # hazy_name example: .../dehazing/RESIDE/haze/part1/3241_XXX.jpg
        # climb up to RESIDE then join with clear
